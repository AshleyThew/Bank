...
public class BalanceArgument extends BankEndArgument {
    ...
    protected void onArgument(CommandSender s, Command cmd, String label, String[] args, String[] original) {
        ...
        BankLanguageConfiguration.sendFormattedMessage(s, BankLanguageConfiguration.BANK_ADMIN_MONEY_BALANCE.get()
                .replaceAll("<money>", Format.formatMoney(bankInfo.getMoneyInfo().getMoney()))
