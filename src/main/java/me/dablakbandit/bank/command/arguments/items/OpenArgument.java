package me.dablakbandit.bank.command.arguments.items;
...
public class OpenArgument extends BankEndArgument {
	...
	protected void onArgument(CommandSender s, Command cmd, String label, String[] args, String[] original) {
		...
		bankInfo.getPinInfo().checkPass(() -> BankInventoriesManager.getInstance().open(pl, BankInventories.BANK_ITEMS, OpenTypes.ITEMS));
	}
