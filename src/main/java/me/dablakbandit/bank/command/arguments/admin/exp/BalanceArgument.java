...
public class BalanceArgument extends BankEndArgument {
    ...
    protected void onArgument(CommandSender s, Command cmd, String label, String[] args, String[] original) {
        ...
        BankLanguageConfiguration.sendFormattedMessage(s, BankLanguageConfiguration.BANK_ADMIN_EXP_BALANCE.get()
                .replaceAll("<exp>", Format.formatExp(bankInfo.getExpInfo().getExp()))
