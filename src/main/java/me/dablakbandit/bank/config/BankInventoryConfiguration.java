...
public class BankInventoryConfiguration extends CommentAdvancedConfiguration {
	...
	public static final InventoryDescriptionPath BANK_CHEQUE_MENU = new InventoryDescriptionPath(9, "Bank Cheques", "bank.open.cheques");
	public static final InventoryDescriptionPath BANK_CHEQUE_CREATE = new InventoryDescriptionPath(9, "Bank Cheques", "bank.open.cheques");
