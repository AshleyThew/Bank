...
import me.dablakbandit.bank.inventory.cheque.BankChequeCreateInventory;
import me.dablakbandit.bank.inventory.cheque.BankChequeInventory;
...
public enum BankInventories implements Consumer<CorePlayers> {
	...
	BANK_CHEQUE_MENU(BankChequeInventory::new, BankInventoryConfiguration.BANK_CHEQUE_MENU, PlayerInventoryHandlers.DENY, OpenTypes.CHEQUES),
	BANK_CHEQUE_CREATE(BankChequeCreateInventory::new, BankInventoryConfiguration.BANK_CHEQUE_CREATE, PlayerInventoryHandlers.DENY, null),
