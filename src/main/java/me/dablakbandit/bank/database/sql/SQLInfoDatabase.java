...
public abstract class SQLInfoDatabase extends SQLListener implements IInfoDatabase {
	protected final Set<String> infoTypeDatabaseSet = new HashSet<>();
	protected final Map<Class<?>, SQLInfoTypeDatabase<?>> infoTypeDatabasesMap = new HashMap<>();
	...
	public abstract SQLUUIDDatabase getUUIDDatabase();

	public abstract SQLPlayerLockDatabase getPlayerLockDatabase();

	public abstract SQLTransactionDatabase getMoneyTransactionDatabase();
