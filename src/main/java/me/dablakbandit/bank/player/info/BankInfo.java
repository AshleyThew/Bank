...
public class BankInfo extends CorePlayersInfo {
	...
	private void init() {
		...
		pl.addInfo(this.moneyTransactionInfo = new BankMoneyTransactionInfo(pl));
		pl.addInfo(this.expTransactionInfo = new BankExpTransactionInfo(pl));
	...
	public BankMoneyTransactionInfo getMoneyTransactionInfo() {
		return moneyTransactionInfo;
	}
